<?php
/**
 * Autoloader for Diesel classes.
 * All files in /inc/classes/ with a Diesel_ prefix will be autoloaded.
 */

/**
 * The Autoloader class for Diesel.
 */
class Diesel_Autoload {
	...
	protected function get_path( $class_name ) {
		...
		$template_dir_path = Diesel::$template_dir_path;

    $paths = [];
    
    // Collect all class files with our themes prefix
		if ( 0 === stripos( $class_name, 'Diesel_' ) ) {
