...
<section
  class="has-tailwind diesel-block-banner"
  data-block-id="<?php echo $attributes['instanceId'] ?>"
  data-block-type="diesel-banner"
>
  ...
  <div class="relative z-[2] container text-center text-white flex flex-col items-center [&_a]:mt-4">
      <?php echo $content; ?>
    </div>
  </div>
</section>